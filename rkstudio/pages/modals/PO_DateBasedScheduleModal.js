class PO_DateBasedScheduleModal {
    /**
     ...
     */
    start_date_input() {
        return cy.get('[ng-model="schedule.StartDate"]');
    }
     ...
     */
    repeat_select() {
        return cy.get('[ng-model="schedule.repeat"]');
    }
...
export default PO_DateBasedScheduleModal;